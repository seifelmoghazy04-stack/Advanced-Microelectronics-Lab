...
// --- Precomputed Weights (Exported from Python later) ---
// extern const float mel_weight_matrix[513][NUM_MEL_BINS];
// extern const float dct_matrix[NUM_MFCC][NUM_MEL_BINS];
...
// int main() {
//     for (int i = 0; i < AUDIO_LEN; i++) raw_audio[i] = test_raw_audio[i];
//     init_window();
//     process_audio_to_model_input();
//     int errors = 0;
//     for (int i = 0; i < NUM_FRAMES; i++)
//         for (int j = 0; j < NUM_MFCC; j++)
//             errors += conv1_input[0][i][j][0] != expected_model_input[0][i][j][0];
//
//     printf("%d\n", errors);
//     return 0;
// }