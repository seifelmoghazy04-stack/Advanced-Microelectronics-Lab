...
HD_PWD='D:/University Stuff/Vivado/10th Lab/lab_1/lab_1.runs/task_0_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task_0_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task_0_auto_pc_0.tcl
