...
HD_PWD='D:/University Stuff/Vivado/10th Lab/lab_1/lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_task_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soc_task_1_wrapper.tcl -notrace
