...
HD_PWD='D:/University Stuff/Vivado/10th Lab/lab_1/lab_1.runs/soc_task_1_MAC_big_hls_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_task_1_MAC_big_hls_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_task_1_MAC_big_hls_0_1.tcl
