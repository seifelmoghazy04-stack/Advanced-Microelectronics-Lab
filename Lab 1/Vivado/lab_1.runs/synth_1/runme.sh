...
HD_PWD='D:/University Stuff/Vivado/10th Lab/lab_1/lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_task_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_task_1_wrapper.tcl
