...
--Date        : Sun Feb 15 12:01:12 2026
--Host        : DESKTOP-13V46NK running 64-bit major release  (build 9200)
--Command     : generate_target task_1.bd
--Design      : task_1
...
entity task_1 is
  ...
  attribute CORE_GENERATION_INFO of task_1 : entity is "task_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=task_1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of task_1 : entity is "task_1.hwdef";
end task_1;

architecture STRUCTURE of task_1 is
  component task_1_processing_system7_0_0 is
  port (
  ...
  end component task_1_processing_system7_0_0;
...
begin
processing_system7_0: component task_1_processing_system7_0_0
     port map (
