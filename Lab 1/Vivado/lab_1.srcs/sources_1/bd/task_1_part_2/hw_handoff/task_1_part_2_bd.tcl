...
################################################################
# This is a generated script based on design: task_1_part_2
#
...
# source task_1_part_2_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: MAC_0, and set properties
  set block_name MAC
  set block_cell_name MAC_0
  if { [catch {set MAC_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: MAC_1, and set properties
  set block_name MAC
  set block_cell_name MAC_1
  if { [catch {set MAC_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $MAC_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
